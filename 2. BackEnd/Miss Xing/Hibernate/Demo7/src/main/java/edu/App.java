...
public class App {
    ...
    private static void entityGraph(){
        ...
        cust1.addBook(new Book("Harry potter and mmm",new Author("J.K. Rowlings")));
        cust1.addBook(new Book("Harry potter and mmmUnseen Academicals",new Author("Terry Pratchett")));
        cust1.addBook(new Book("Color of Magic",new Author("Terry Pratchett")));

        cust2.addBook(new Book("Twilight",new Author("Stephenie Meyer")));
    ...
    private static void batchSizeOrSubselect(){
        ...
        sr1.addCustomer(new Customer("Frank","Brown"));
        sr1.addCustomer(new Customer("Jana","Terrien"));
        sr2.addCustomer(new Customer("John","Doe"));
        sr2.addCustomer(new Customer("Carol","Reno"));
...
//            System.out.println("3....................");
//            List<Customer> customers=salesRep.getCustomers();
